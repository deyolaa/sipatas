            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="03APTamu.html">Daftar Pengajuan</a></li>
                        <li class="nav-item"><a class="nav-link" href="03ABukuTamu.html">Buku Tamu</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            ...
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn btn-outline-light btn-lg px-4" href="03APTamu.html">Pengajuan Kunjungan</a>
                                <a class="btn btn-outline-light btn-lg px-4" href="03ABukuTamu.html">Buku Tamu</a>
