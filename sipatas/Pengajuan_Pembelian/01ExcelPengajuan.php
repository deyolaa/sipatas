        ...
        <div id="wrapper">
            ...
            <h5 class="text-black mx-5 mb-3">List Pengajuan Pembelian</h5>
                    ...
                    <button type="button" id="downloadexcel" class="btn btn-success"><i class="bi bi-file-earmark-excel"></i></i>Download Excel</button>
                        <table class="table table-striped table-sm table-bordered"  id="pengajuansapi" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>ID Pengajuan</th>
            ...
            <script>
                document.getElementById('downloadexcel');addEventListener('click',function () {
                    ...
                    table2excel.export(document.querySelectorAll("#pengajuansapi"));
                })
            </script>    
