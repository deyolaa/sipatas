<html>
    ...
    <body  style="background-color: white;">
        ...
        <div id="wrapper">
                ...
                <div id="content" class="mx-4">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                          <a class="navbar-brand fw-bolder" href="02AAbsen.php">Absensi Peserta Magang</a>
            ...
            <!-- Table-->
            <h5 class="text-black my-3">List Absen <input type="date" class="mx-4"> </h5> 
                        ...
                        ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-primary" style="background-color: blue;" href="02ADetailPermohonan.php"><i class="bi bi-info-lg"></i></a>
