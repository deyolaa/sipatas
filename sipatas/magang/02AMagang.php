            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="02AMagang.php">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="02APermohonan.php">Permohonan Magang</a></li>
                        <li class="nav-item"><a class="nav-link" href="02AAbsen.php">Absensi Peserta</a></li>
